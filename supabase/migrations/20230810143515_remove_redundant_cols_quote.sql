...
ALTER TABLE "public"."quote" ALTER COLUMN "installerId" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."Quote_installerId_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE "public"."unsubscribed" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."unsubscribed"
    ADD CONSTRAINT "unsubscribed_pkey" PRIMARY KEY ("email");
...
GRANT ALL ON SEQUENCE "public"."Quote_installerId_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."Quote_installerId_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."Quote_installerId_seq" TO "service_role";
...
GRANT ALL ON TABLE "public"."unsubscribed" TO "anon";
GRANT ALL ON TABLE "public"."unsubscribed" TO "authenticated";
GRANT ALL ON TABLE "public"."unsubscribed" TO "service_role";
