...
export default async function (request: VercelRequest, response: VercelResponse) {
  ...
  // TODO: extract relevant update information from request body and pass this to syncJobData()
  const todo_updateData = { "todo": "todo" }
  var success = await syncJobData(todo_updateData);
...
async function syncJobData(todo_updateData) {
  var success = true;
