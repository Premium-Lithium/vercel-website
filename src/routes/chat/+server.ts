...
Save up to 55% with a preorder on all products. 

5% discount per month from now, capped at 55% when installing in 12 months from now. 

e.g - if it's currently January, a February installation would have a 5% discount. 

e.g - if it's currently March, a July installation would have a 20% discount.  
...
Q: Who manufactures your batteries? 

A: We maintain an exclusive partnership with Delong Energy Company. They might not be widely recognised online, but their reputation in quality production is unparalleled. 

 

Q: What is the lifespan of one of your batteries? 

A: The battery’s lifespan extends up to 37 years when cycled roughly 162 times per year (approximately every other day). This is a more realistic usage pattern than fully charging and discharging daily. Under ideal conditions, this battery promises long-term reliability and efficiency. 

 

Q: How does the preorder model work? 

A: The pre-ordering model has proved to be an effective approach for both Premium Lithium and our customers. Its success is evident from our customer feedback on Trustpilot. By pooling payments from multiple pre-orders, we are able to place larger orders with our manufacturing partners. This strategy leads to significant savings on purchasing, shipping, and installation planning. 

 

Q: What payment protection is in place for preorders? 

A: The payment for pre-orders is not insurance-backed. While insurance-backed payments offer certain security, they introduce additional complexities and costs. These costs would inevitably have to be passed onto our customers, which would offset the benefits of our pre-order savings. For additional security, we provide a complimentary credit card payment service. Utilising this service, you can avail full Section 75 payment protection up to £30,000 through your credit card company. It's an effective way to offer our customers peace of mind without the complexities and costs associated with insurance-backed solutions. 

--- 

SECTION: Why Premium Lithium? 
